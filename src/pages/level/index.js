...
import { LevelBox, LevelContentBox, AuthorLevel, InfoCard } from "./styled";
...
const UserPage = ({ history }) => {
  ...
  return levelsData ? (
    <LevelBox>
      ...
      <AuthorLevel>
        <Image src={sun} width={30} height={30} fit="cover" className="sun" />
        <InfoCard>
...
export default connect(getStoreData, dispatchAction)(UserPage);
